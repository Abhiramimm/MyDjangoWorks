...
class CurrentBillView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form_instance.is_valid():
            ...
            if phase=="singlephase" and unit<100:

                amount=(unit*6.05)+70

            elif phase=="threephase" and unit<100:

                amount=(unit*6.05)+140
            
            elif phase=="singlephase" and unit<200:

                amount=(unit*6.80)+70
            
            elif phase=="threephase" and unit<200:

                amount=(unit*6.80)+140
            
            elif phase=="singlephase" and unit<300:

                amount=(unit*7.50)+70
            
            elif phase=="threephase" and unit<300:

                amount=(unit*7.50)+140
            
            elif phase=="singlephase" and unit<500:

                amount=(unit*8.15)+70
            
            elif phase=="threephase" and unit<500:

                amount=(unit*8.15)+140
